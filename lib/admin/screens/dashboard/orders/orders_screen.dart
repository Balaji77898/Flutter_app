...
class _OrdersScreenState extends State<OrdersScreen> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Spacer(
                  flex:
                      3), // Add space to push the "All Types" dropdown to the left like the screenshot
            ],
          ),
        ],
      ),
  ...
  Widget _statusBadge(String status) {
    ...
    return Container(
      ...
      child: Text(status.toUpperCase() == 'PLACED' ? 'Placed' : status,
          style: GoogleFonts.inter(
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          ...
                          _summaryItem('Status', order.status.toUpperCase(),
                              isBadge: true,
                              badgeCol: const Color(0xFFFEF9C3),
                              textCol: const Color(0xFFCA8A04)),
                          _summaryItem(
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _priceRow('Subtotal',
                              order.calculatedSubtotal.toStringAsFixed(2)),
                          const SizedBox(height: 8),
                          _priceRow('Tax', '0.00'),
      ...
      children: [
        ...
        Text('₹$value',
            style: TextStyle(
                ...
                color: isTotal ? AppColors.rubyDark : AppColors.textDark)),
      ],
    );
  }
